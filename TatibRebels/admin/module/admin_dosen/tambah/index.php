...
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/js/select2.min.js"></script>
    ...
    <div class="form-container">
        ...
        <div class="form-content">
            <form action="fungsi/tambah.php?dosen=tambah" method="post" enctype="multipart/form-data" id="reportForm" style="display: flex; gap: 16px;">
                <div class="input-field-laporan">
                    <label for="nama">Nama <span style="color: red" for="nama">*</span></label>
                    <input type="text" id="nama" name="nama" placeholder="Masukkan nama" required>
                </div>
                <div class="input-field-laporan">
                    <label for="nip">NIP <span style="color: red" for="nip">*</span></label>
