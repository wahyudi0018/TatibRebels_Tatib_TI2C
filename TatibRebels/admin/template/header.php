...
<body>
    ...
    <div class="header">
        ...
        <div class="tab-section">
            ...
            <a href="index.php?page=admin_dosen" class="nav-menu tab-riwayat-pelanggaran">
                Dosen
            </a>
            <a href="index.php?page=admin_mahasiswa" class="nav-menu tab-panduan-tatib">
                Mahasiswa
            </a>
            <a href="index.php?page=admin_tatib" class="nav-menu tab-panduan-tatib">
                Panduan Tata Tertib
            </a>
        </div>
        <div class="profil-section">
            <div class="profil-container">
                ...
                <!-- Fungsi Tampil Nama dan No -->
                    <?php
                    echo '<p>' . $admin->tampilNama() . '</p>';
                    echo '<p>' . $admin->tampilNO() . '</p>';
                    ?>
                </div>
            </div>
