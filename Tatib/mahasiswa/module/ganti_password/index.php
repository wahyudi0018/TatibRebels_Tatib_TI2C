...
<link rel="stylesheet" href="assets/css/Style.css">    
    ...
    <div class="form-container">
        ...
        <form action="fungsi/ganti_password.php?mahasiswa=tambah" method="post" enctype="multipart/form-data" id="reportForm" style="display: flex; gap: 16px;">
