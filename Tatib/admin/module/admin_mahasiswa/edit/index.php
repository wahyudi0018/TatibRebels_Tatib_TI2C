...
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/js/select2.min.js"></script>
    ...
    <div class="form-container">
        ...
        <div class="form-content">
            <form action="fungsi/edit.php?mahasiswa=edit" method="post" enctype="multipart/form-data" id="reportForm" style="display: flex; gap: 16px;">
            <!-- Fungsi Edit Data Mahasiswa -->
            <?php
            $id_mhs = $_GET['id_mhs'];
            $row = $admin -> editDataMahasiswa();
            ?>
                ...
                <div class="input-field-laporan">
                    ...
                    <input type="text" id="nim" name="nim" placeholder="Masukkan NIM" value="<?= $row['nim'] ?>">
                </div>
                <div class="input-field-laporan">
