...
<link rel="stylesheet" href="assets/css/Style.css">
    ...
    <div class="container-riwayat-pelanggaran">
        <div class="title">
            <p style="font-size: 20px; font-weight: var(--font-weight-manrope-bold);">Data Mahasiswa</p>
        </div>
        <div class="container-tambah-search">
            <a href="index.php?page=admin_mahasiswa/tambah" class="btn-tambah-data" style="text-decoration: none;">
                ...
                <p style="font-weight: var(--font-weight-manrope-medium);">Tambah Mahasiswa</p>
            </a>
        </div>
        <?php
        ...
        <table>
            <thead>
                <tr>
                    <th class="nama-mhs-column">Nama</th>
